...
SECRET_KEY = 'django-insecure-1l8#)y_@-!@!sy)457bju!o3g+d9sy=xjgqni@%y%j7(a(he1f'
...
# CSRF and CORS settings for Codespaces
...
if os.environ.get('CODESPACE_NAME'):
    ...
    CORS_ALLOWED_ORIGINS.append(f"https://{codespace_name}-3000.preview.app.github.dev")
